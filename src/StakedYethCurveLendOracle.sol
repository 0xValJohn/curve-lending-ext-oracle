...
contract StakedYethCurveLendOracle {
    ...
    IPriceOracle public constant CL_CRV_USD = IPriceOracle(0xCd627aA160A6fA45Eb793D19Ef54f5062F20f33f);

    function price() public view returns (uint256) {
        return (ST_YETH.totalAssets() * 1e18) / ST_YETH.totalSupply() * YETH_ETH.price_oracle()
            * uint256(CL_ETH_USD.latestAnswer()) / (uint256(CL_CRV_USD.latestAnswer()) * 1e18);
    }
